...
def center(x, y, p, coords, dxl_io):
    ids1 = [11, 12, 13]
    ids2 = [21, 22, 23]
    ids3 = [31, 32, 33]
    ids4 = [41, 42, 43]
...
def dance(coords, p, dxl_io):    
    coords = center(30, 0, p, coords, dxl_io)
    coords = center(-30, 0, p, coords, dxl_io)
        
    coords = center(0, 30, p, coords, dxl_io)
    coords = center(0, -30, p, coords, dxl_io)
    ...
    coords = center(30, 30, p, coords, dxl_io)
    coords = center(-30, -30, p, coords, dxl_io)
